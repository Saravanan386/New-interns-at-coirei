...
from app.schemas import ChapterResourceResponse
...
def upload_chapter_resources(
    ...
    folder = os.path.join(UPLOAD_DIR, str(chapter_id))
...
def download_resource(
    ...
    resource = (
        ...
        .filter(ChapterResource.id == resource_id)
        .first()
    )
    ...
    return FileResponse(path=resource.file_path, filename=resource.file_name)
